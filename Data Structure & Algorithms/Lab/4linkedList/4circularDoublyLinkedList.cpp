// Lab 4.4: Implementation of circular doubly linked list
#include <iostream>
#include <stdlib.h>
using namespace std;
struct NODE
...
public:
	...
	void insertAtFront()
	{
		...
		cout << endl
			 << "Inserted " << newNode->data << " at the front" << endl;
	}
	void insertAtEnd()
	{
		Node *newNode = createNode();
		...
		cout << endl
			 << "Inserted " << newNode->data << " at the end" << endl;
	}
	...
	void search()
	{
		...
		else
		{
			...
			if (found)
				cout << endl
					 << "Element " << key << " found at position " << pos << endl;
			else
				cout << endl
					 << "Element " << key << " not found in linked list" << endl;
		}
	}
	void traverse()
	{
	...
	do
	{
		...
		case 1:
			...
			else if (ch2 == 2)
			{
				int n;
				cout << endl
					 << "Enter position of node to insert before : ";
				cin >> n;
				if (n <= 1)
					list.insertAtFront();
				else
			...
			else if (ch2 == 3)
			{
				int n;
				cout << endl
					 << "Enter position of node to insert after : ";
				cin >> n;
		...
		case 2:
			...
			else if (ch2 == 2)
			{
				int n;
				cout << endl
					 << "Enter position of node to delete before : ";
				cin >> n;
				if (n <= 1)
			...
			else if (ch2 == 3)
			{
				int n;
				cout << endl
					 << "Enter position of node to delete after : ";
				cin >> n;
				list.deleteAtMiddle(n + 1);
			}
			else if (ch2 == 4)
