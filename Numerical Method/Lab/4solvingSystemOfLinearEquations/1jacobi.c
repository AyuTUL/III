// Lab 4.1: WAP in C that solves system of linear equations using Jacobi method
#include <stdio.h>
#include <math.h>
#define MAX 10
...
{
    int n, i, j, itr = 1;
    float a[MAX][MAX + 1], tolerance, x[MAX] = {0}, x_new[MAX], error;
