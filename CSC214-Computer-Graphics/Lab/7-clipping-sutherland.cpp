/*
Lab 7: Implementation of clipping using Cohen Sutherland algorithm.
    a. Enter the clip window coordinates: 200, 200, 400, 400. Enter the endpoint: 150 150 350 350
    b. Enter the clip window coordinates: 100, 100, 400, 400. Enter the endpoint: 50 50 250 350
*/
// g++ 7clippingSutherland.cpp -o 7clippingSutherland -lbgi -lgdi32 -lcomdlg32 -luuid -loleaut32 -lole32 && .\\7clippingSutherland
#include <iostream>
#include <graphics.h>
using namespace std;
struct Point
